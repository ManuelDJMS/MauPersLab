...
Module Conexiones
    ...
    Public conexiontransaccion As String = ("Data Source=PC92-L\SISTEMAS;Initial Catalog=MAULABS; Integrated Security=True")
    ...
    Sub Metodo()
        ...
        conexion = New SqlConnection("Data Source=PC92-L\SISTEMAS;Initial Catalog=MAULABS; Integrated Security=True")
